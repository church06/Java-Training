...
public class Plot_LG {
    ...
    public Plot_LG(String title, String xAxis, String yAxis, List<List<Double>> data) {
        ...
        List<List<Double>> plotPoints = Data_LG.plotFunction(xMin, xMax, .1, (x)->0);
 ...
 public void updatePlot(HypothesisFunction_LG h_x) {
        List<List<Double>> plotPoints = Data_LG.plotFunction(xMin,xMax, .1, h_x);
